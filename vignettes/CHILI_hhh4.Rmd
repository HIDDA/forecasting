---
title: "Forecasting Swiss ILI surveillance counts using `hhh4`"
...
output:
    rmarkdown::html_vignette:
        ...
        toc: TRUE
vignette: >
  %\VignetteIndexEntry{Forecasting Swiss ILI surveillance counts using 'hhh4'}
...
hhh4fit <- hhh4(stsObj = CHILI.sts,
     control = list(
         ...
         family = "NegBin1", subset = TRAIN1[-1],
