...
```{r, eval = FALSE}
## fix: should not do model selection here, right?
arimaowa <- sapply(OWA, function (t) {
    arimafit <- auto.arima(log1p(CHILI[1:t]), stepwise=FALSE, approximation=FALSE)
    unlist(predict(arimafit, nahead=1))
})
```
