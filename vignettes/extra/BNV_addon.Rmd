...
vignette: >
  ...
  %\VignetteDepends{surveillance, hhh4contacts, hhh4addon, lattice, fanplot}
---
...
invisible(mapply(fanplot_prediction, predmoms, main = names(predmoms),
                 MoreArgs = list(unit = .group, xlab = "Time")))
```
...
invisible(mapply(plot_moments_by_unit, predmoms_aggr, main = names(predmoms_aggr),
                 MoreArgs = list(xlab = "Age group", ylim = c(0, 3000), pt.cex = 0.6)))
```
