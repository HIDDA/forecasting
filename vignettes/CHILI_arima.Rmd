...
```{r sarimaxowa_scores_discretized, include = FALSE}
## compare with scores for discretized forecast distributions
...
## => as expected, no relevant difference compared to continuous scores
stopifnot(
